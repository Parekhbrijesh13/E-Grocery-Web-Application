...
<head>
    <title>@yield('title', 'Darshan Super market')</title>
        ...
        <div class="container-fluid">
            <div class="row py-3 border-bottom">
                ...
                <div class="col-sm-4 col-lg-3 text-center text-sm-start">
                    <div class="main-logo">
                        <a href="index.html">
                            <img src="{{ asset('assets/images/Supermarketlogo.png') }}" alt="logo"
                ...
                <div
                    ...
                    <div class="support-box text-end d-none d-xl-block">
                        ...
                        <h5 class="mb-0">+91 6359061142</h5>
                    </div>

                    <ul class="d-flex justify-content-end list-unstyled m-0">
                        <li>
                            <a href="{{ route('Auth.login') }}" class="rounded-circle bg-light p-2 mx-1">
                        ...
                        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
                            ...
                            <div class="offcanvas-body">
                                ...
                                <ul
                                    ...
                                    <li class="nav-item">
                                        <a href="#Today-offers" class="nav-link">Today's Offers</a>
                                    </li>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6 copyright">
                    <p>© 2026 Darshan Super market. All rights reserved.</p>
                </div>
                <div class="col-md-6 credit-link text-start text-md-end">
                    <p>Developed by <a href="https://parekhbrijesh13.github.io/">Parekh Brijesh</a>
                    </p>
                </div>
            </div>
        </div>
